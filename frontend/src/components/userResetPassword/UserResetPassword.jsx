...
import {toastSuccess, toastWarning } from '../../utlis/toast';
...
export default function UserResetPassword() {
  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-auto lg:py-0">
      ...
      <div class="w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
          ...
          <form class="mt-4 space-y-4 lg:mt-5 md:space-y-5" onSubmit={handleChangePassword}>
              
              <div>
                  <label htmlForfor="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">New Password</label>
                  <input type="password"
                  value={password}
