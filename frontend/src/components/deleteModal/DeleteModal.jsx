        ...
        <div className="relative p-4 w-full max-w-xl">
          <div className="relative p-4 bg-gray-200 rounded-lg shadow dark:bg-gray-800 sm:p-5">
            <div class="relative p-4 text-center bg-gray-200 rounded-lg shadow dark:bg-gray-800 sm:p-5">
              ...
              <h3 class="mb-2 mt-5 text-lg font-semibold text-gray-900 dark:text-white">{`Are you sure you want to delete this ${title}?`}</h3>
              <div
              ...
              >
                ...
                <p>{`By deleting this ${message} will also be permanently deleted.`}</p>
              </div>
