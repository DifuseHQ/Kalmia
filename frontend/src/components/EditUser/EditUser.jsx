        ...
        >
          ...
          <div className='flex my-4'>
            ...
            <input
              ...
              name='username'
              id='username'
              className={`bg-gray-50 ${true ? 'border border-gray-500 focus:ring-primary-600 focus:border-primary-600 dark:bg-gray-600 dark:border-white' : ''} text-gray-900 text-sm rounded-lg  block  p-1 px-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500`}
              readOnly='{!isEdit}'
            />
          </div>
