            ...
            <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
              ...
              <div className='space-y-4 md:space-y-6'>
                ...
                <div className="grid gap-4 grid-cols-3">
                  <button onClick={handleGitHubLogin} className="w-full inline-flex items-center justify-center py-2.5 px-5 focus:ring-2 dark:focus:ring-2 focus:outline-none focus:ring-gray-700 dark:focus:ring-gray-700 font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
